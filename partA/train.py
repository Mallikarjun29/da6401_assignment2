...
def get_filter_counts(base_filters, n_layers, strategy):
    ...
    Args:
        base_filters (int): Initial number of filters
        n_layers (int): Number of layers
        strategy (str): Strategy for filter progression
        
    Returns:
        list: Number of filters for each layer
    """
    if strategy == 'same':
